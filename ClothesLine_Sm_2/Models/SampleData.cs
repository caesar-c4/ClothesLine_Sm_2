...
using ClothesLine_Sm_2.Models;

namespace ClothesLine_Sm_2.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<ClothesLine_Sm_2Context>
    {
        protected override void Seed(ClothesLine_Sm_2Context context)
        {
